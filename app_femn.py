"""
LC/MC FeMn Alloy Forecasting Dashboard  ·  v2.3
=================================================
Includes strict hover isolation, Regime Tracking, Market Comparison, and Carbon Penalty VIU Math.
"""
...
c6.metric("Scaling Factor", f"{meta.get('scaling_factor', 0):.4f}", help=f"Anchor: {meta.get('anchor_date')} = ₹{meta.get('anchor_price')}")
